...
public class Main {
	...
	public static void main(String[] args) {
		...
		List/*<implement>*/ plist = Utility.MakePayableList(list1, list2);
		...
		System.out.println(Utility.GenderCount(plist, Gender.MALE)); // should print 6 to the console
		
		System.out.println("Gender Female Count:");
		System.out.println(Utility.GenderCount(plist, Gender.FEMALE)); // should print 4 to the console
